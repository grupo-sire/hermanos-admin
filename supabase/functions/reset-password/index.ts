...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const emailRemetente = empresa?.email || "noreply@resend.dev";
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="padding: 30px 20px;">
          ...
          <p style="color: #666; line-height: 1.6;">Você recebeu uma solicitação para redefinir sua senha de acesso ao sistema <strong>${nomeEmpresa}</strong>.</p>
